          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-5">
              ...
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-slate-800 font-bold">Patients Appointments 📝</h1>
              </div>
            ...
            {/* Table */}
            <AppointmentTable sButton={searchButtonIsPressed} searchQuery={search} selectedItems={handleSelectedItems} />
